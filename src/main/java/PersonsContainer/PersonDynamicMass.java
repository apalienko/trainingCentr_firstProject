...
public class PersonDynamicMass implements DynamicMass<Person> {
	...
	/** ѕоле переменна€ основного массива */
	private Person[] mass;
	...
	/**
	 *  онструктор - создает объект с заданным начальным
	 * размером массива и выставл€ет значение <b>size</b>
	 * равным нулю
	 * 
	...
	public void delete(int index) {
		...
		if(size <= newSize && newSize >= START_SIZE) {
			...
			if(noElemInSecondPart) {
				// »терационна€ переменна€ дл€ нового уменьшенного массива
				int j = 0;
